...
dsk_err_t posix_openalt(DSK_DRIVER *self, const char *filename, DSK_REPORTFUNC diagfunc);
dsk_err_t posix_openoo(DSK_DRIVER *self, const char *filename, DSK_REPORTFUNC diagfunc);
dsk_err_t posix_openob(DSK_DRIVER *self, const char *filename, DSK_REPORTFUNC diagfunc);
...
dsk_err_t posix_closedsk(DSK_DRIVER *self);
